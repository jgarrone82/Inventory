    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WarehouseId = table.Column<Guid>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e87cb30e-c38b-4213-b2d1-20842fe6357e"), "4709 Plume Rd NW", "Central Warehouse" },
                    { new Guid("3474c4b3-08d6-4b96-b544-7ad44f4a5c3e"), "425 San Felipe St NW", "North Warehouse" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductDescription", "ProductName", "TotalQuantity" },
                values: new object[] { "MPH-98745", "MPH", "", "Samsung Galaxy S22 +", 0 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductDescription", "ProductName", "TotalQuantity" },
                values: new object[] { "VDG-54658", "VDG", "", "Nintendo Switch Neon 64 Gb", 0 });
